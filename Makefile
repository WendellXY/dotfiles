...
.PHONY: install brew nix nvim nushell nushell-linux fish zsh fastfetch starship atuin alacritty wezterm kitty warp ghostty zed bat yazi sketchybar aerospace yabai tmux
...
${HOME}/Library/Application\ Support/nushell:
	ln -sfn "${BASE_DIR}/nushell" "${HOME}/Library/Application Support/nushell"

nushell-linux: | ${HOME}/.config/nushell
	@echo "Nushell configuration installed"

${HOME}/.config/nushell:
	ln -sfn ${BASE_DIR}/nushell ${HOME}/.config/nushell
...
${HOME}/.config/fish: ${HOME}/.config
	ln -sfn ${BASE_DIR}/fish ${HOME}/.config/fish
...
${HOME}/.zshenv:
	ln -sfn ${BASE_DIR}/zsh/.zshenv ${HOME}/.zshenv
...
${HOME}/.config/starship: ${HOME}/.config
	ln -sfn ${BASE_DIR}/starship ${HOME}/.config/starship
...
${HOME}/.config/atuin: ${HOME}/.config
	ln -sfn ${BASE_DIR}/atuin ${HOME}/.config/atuin
...
${HOME}/.config/alacritty: ${HOME}/.config
	ln -sfn ${BASE_DIR}/alacritty ${HOME}/.config/alacritty
...
${HOME}/.config/wezterm: ${HOME}/.config
	ln -sfn ${BASE_DIR}/wezterm ${HOME}/.config/wezterm
...
${HOME}/.config/kitty: ${HOME}/.config
	ln -sfn ${BASE_DIR}/kitty ${HOME}/.config/kitty
...
${HOME}/.warp:
	ln -sfn ${BASE_DIR}/warp ${HOME}/.warp
...
${HOME}/.config/zed: ${HOME}/.config
	ln -sfn ${BASE_DIR}/zed ${HOME}/.config/zed
...
${HOME}/.config/bat: ${HOME}/.config
	ln -sfn ${BASE_DIR}/bat ${HOME}/.config/bat
...
${HOME}/.config/yazi: ${HOME}/.config
	ln -sfn ${BASE_DIR}/yazi ${HOME}/.config/yazi
...
${HOME}/.config/sketchybar: ${HOME}/.config
	ln -sfn ${BASE_DIR}/sketchybar ${HOME}/.config/sketchybar
...
${HOME}/.config/aerospace: ${HOME}/.config
	ln -sfn ${BASE_DIR}/aerospace ${HOME}/.config/aerospace
...
${HOME}/.config/yabai: ${HOME}/.config
	ln -sfn ${BASE_DIR}/yabai ${HOME}/.config/yabai
