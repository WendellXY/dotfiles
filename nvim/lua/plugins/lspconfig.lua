...
return {
	...
	},
	{
		...
		dependencies = {
			...
			{ "williamboman/mason.nvim", lazy = false, config = true }, -- NOTE: Must be loaded before dependants
		...
		config = function()
			...
			vim.api.nvim_create_autocmd("LspAttach", {
				...
				callback = function(event)
					...
					map("<leader>sd", require("telescope.builtin").lsp_document_symbols, "Search [D]ocument Symbols")

					-- Fuzzy find all the symbols in your current workspace.
					--  Similar to document symbols, except searches over your entire project.
					map("<leader>sp", require("telescope.builtin").lsp_dynamic_workspace_symbols, "Search [Project] Symbols")
					...
					map("<leader>va", vim.lsp.buf.code_action, "Code Action", { "n", "x" })
